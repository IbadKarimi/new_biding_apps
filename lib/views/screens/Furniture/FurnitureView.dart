          ...
          child: Column(
            ...
            children: [
              Row(children: [
                ...
                Padding(
                  padding: EdgeInsets.only(top: 10.h, left: 110.w, bottom: 0.h),
                  child:  Text(
                    "Add Products",
                    style: TextStyle(
                      color: Colors.black,
                ...
                Padding(
                    ...
                    child: IconButton(onPressed: (){    Get.to(()=>AddFurnitureView());}, icon: Icon(Icons.add_circle_outline,color: Colors.blue,size: 30,)))
              ],),
              for(int i=0;i<10;i++)
                Column(
                  children: [

...
class RealStateView extends StatefulWidget{
  @override
  State<RealStateView > createState() => _RealStateViewState();
}
...
class _RealStateViewState extends State<RealStateView > {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('realState').snapshots(),
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: ()async{
                  ...
                  prefs.setString("id", realStateDocId);

...
class AcceptRejectBidView extends StatefulWidget{

  @override
  State<AcceptRejectBidView> createState() => _AcceptRejectBidViewState ();
}
                ...
                child:Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Container(
                            margin: EdgeInsets.only(top:10.h,left:5.w,bottom: 10.h),
                            width: 160.w,
                            height: 35.h,
                            child: ElevatedButton(
                                ...
                                onPressed: () {
                                  try{
                                    homePageController.updateStatus(_storedValue, "Rejected");
                                    homePageController.updateStatusWithCollection(_storedValue, "Rejected","vehicle");
                        ...
                        Container(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: () {
                                  homePageController.updateStatus(_storedValue, "Completed");
                                  homePageController.updateStatusWithCollection(_storedValue, "Completed","vehicle");
